...
//    }
    ...
    public void SE(WebDriver driver, String locator) {
    ...
    public void doubleClickToElement(WebDriver driver, String locator) {
        ...
        actions.doubleClick(getWebElement(driver, locator));
    }
    ...
    public void hoverMouseToElement(WebDriver driver, String locator) {
        actions = new Actions(driver);
        actions.moveToElement(getWebElement(driver, locator));
    }

    public void hoverMouseToElement(WebDriver driver, String locator, String... params) {
        actions = new Actions(driver);
        actions.moveToElement(getWebElement(driver, locator, params));
    }

    public void rightClickToElement(WebDriver driver, String locator) {
        actions = new Actions(driver);
        actions.contextClick(getWebElement(driver, locator));
    }

    public void rightClickToElement(WebDriver driver, String locator, String... params) {
        actions = new Actions(driver);
        actions.contextClick(getWebElement(driver, locator, params));
    }
